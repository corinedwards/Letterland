...
`)}function R_(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(hs).join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `};this.distortionPass=new _r(i),this.distortionPass.enabled=!1,this.composer.addPass(this.distortionPass);const r={uniforms:{tDiffuse:{value:null},resolution:{value:new he(this.container.clientWidth,this.container.clientHeight)},brightness:{value:1.05},scanlineIntensity:{value:.15},vignetteIntensity:{value:.5},glowIntensity:{value:.3}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
