...
void main() {
	...
	`}function Tg(r){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Co||c===Po,h=c===Fi||c===Bi;if(l||h){let u=e.get(a);const f=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return t===null&&(t=new $c(r)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const p=a.image;return l&&p&&p.height>0||h&&p&&i(p)?(t===null&&(t=new $c(r)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function i(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function s(a){const c=a.target;c.removeEventListener("dispose",s);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function bg(r){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Ai("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Ag(r,e,t,n){const i={},s=new WeakMap;function o(u){const f=u.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",o),delete i[f.id];const p=s.get(f);p&&(e.remove(p),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(u,f){return i[f.id]===!0||(f.addEventListener("dispose",o),i[f.id]=!0,t.memory.geometries++),f}function c(u){const f=u.attributes;for(const p in f)e.update(f[p],r.ARRAY_BUFFER)}function l(u){const f=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const w=p.array;_=p.version;for(let v=0,x=w.length;v<x;v+=3){const I=w[v+0],C=w[v+1],P=w[v+2];f.push(I,C,C,P,P,I)}}else if(g!==void 0){const w=g.array;_=g.version;for(let v=0,x=w.length/3-1;v<x;v+=3){const I=v+0,C=v+1,P=v+2;f.push(I,C,C,P,P,I)}}else return;const m=new(Hl(f)?ql:Xl)(f,1);m.version=_;const d=s.get(u);d&&e.remove(d),s.set(u,m)}function h(u){const f=s.get(u);if(f){const p=u.index;p!==null&&f.version<p.version&&l(u)}else l(u);return s.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function wg(r,e,t){let n;function i(f){n=f}let s,o;function a(f){s=f.type,o=f.bytesPerElement}function c(f,p){r.drawElements(n,p,s,f*o),t.update(p,n,1)}function l(f,p,g){g!==0&&(r.drawElementsInstanced(n,p,s,f*o,g),t.update(p,n,g))}function h(f,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];t.update(m,n,1)}function u(f,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)l(f[d]/o,p[d],_[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,f,0,_,0,g);let d=0;for(let w=0;w<g;w++)d+=p[w]*_[w];t.update(d,n,1)}}this.setMode=i,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Rg(r){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,o,a){switch(t.calls++,o){case r.TRIANGLES:t.triangles+=a*(s/3);break;case r.LINES:t.lines+=a*(s/2);break;case r.LINE_STRIP:t.lines+=a*(s-1);break;case r.LINE_LOOP:t.lines+=a*s;break;case r.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Cg(r,e,t){const n=new WeakMap,i=new Qe;function s(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(a);if(f===void 0||f.count!==u){let E=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",E)};f!==void 0&&f.texture.dispose();const p=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],d=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let v=0;p===!0&&(v=1),g===!0&&(v=2),_===!0&&(v=3);let x=a.attributes.position.count*v,I=1;x>e.maxTextureSize&&(I=Math.ceil(x/e.maxTextureSize),x=e.maxTextureSize);const C=new Float32Array(x*I*4*u),P=new Gl(C,x,I,u);P.type=tn,P.needsUpdate=!0;const U=v*4;for(let M=0;M<u;M++){const F=m[M],z=d[M],W=w[M],K=x*I*4*M;for(let oe=0;oe<F.count;oe++){const Z=oe*U;p===!0&&(i.fromBufferAttribute(F,oe),C[K+Z+0]=i.x,C[K+Z+1]=i.y,C[K+Z+2]=i.z,C[K+Z+3]=0),g===!0&&(i.fromBufferAttribute(z,oe),C[K+Z+4]=i.x,C[K+Z+5]=i.y,C[K+Z+6]=i.z,C[K+Z+7]=0),_===!0&&(i.fromBufferAttribute(W,oe),C[K+Z+8]=i.x,C[K+Z+9]=i.y,C[K+Z+10]=i.z,C[K+Z+11]=W.itemSize===4?i.w:1)}}f={count:u,texture:P,size:new he(x,I)},n.set(a,f),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(r,"morphTexture",o.morphTexture,t);else{let p=0;for(let _=0;_<l.length;_++)p+=l[_];const g=a.morphTargetsRelative?1:1-p;c.getUniforms().setValue(r,"morphTargetBaseInfluence",g),c.getUniforms().setValue(r,"morphTargetInfluences",l)}c.getUniforms().setValue(r,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(r,"morphTargetsTextureSize",f.size)}return{update:s}}function Pg(r,e,t,n){let i=new WeakMap;function s(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),i.get(c)!==l&&(t.update(c.instanceMatrix,r.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,r.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;i.get(f)!==l&&(f.update(),i.set(f,l))}return u}function o(){i=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:s,dispose:o}}const ph=new Mt,tl=new th(1,1),mh=new Gl,gh=new Ku,_h=new Zl,nl=[],il=[],sl=new Float32Array(16),rl=new Float32Array(9),ol=new Float32Array(4);function Qi(r,e,t){const n=r[0];if(n<=0||n>0)return r;const i=e*t;let s=nl[i];if(s===void 0&&(s=new Float32Array(i),nl[i]=s),e!==0){n.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,r[o].toArray(s,a)}return s}function _t(r,e){if(r.length!==e.length)return!1;for(let t=0,n=r.length;t<n;t++)if(r[t]!==e[t])return!1;return!0}function vt(r,e){for(let t=0,n=e.length;t<n;t++)r[t]=e[t]}function Rr(r,e){let t=il[e];t===void 0&&(t=new Int32Array(e),il[e]=t);for(let n=0;n!==e;++n)t[n]=r.allocateTextureUnit();return t}function Lg(r,e){const t=this.cache;t[0]!==e&&(r.uniform1f(this.addr,e),t[0]=e)}function Ig(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;r.uniform2fv(this.addr,e),vt(t,e)}}function Dg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(_t(t,e))return;r.uniform3fv(this.addr,e),vt(t,e)}}function Ng(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;r.uniform4fv(this.addr,e),vt(t,e)}}function Ug(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;r.uniformMatrix2fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;ol.set(n),r.uniformMatrix2fv(this.addr,!1,ol),vt(t,n)}}function Og(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;r.uniformMatrix3fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;rl.set(n),r.uniformMatrix3fv(this.addr,!1,rl),vt(t,n)}}function Fg(r,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;r.uniformMatrix4fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;sl.set(n),r.uniformMatrix4fv(this.addr,!1,sl),vt(t,n)}}function Bg(r,e){const t=this.cache;t[0]!==e&&(r.uniform1i(this.addr,e),t[0]=e)}function kg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;r.uniform2iv(this.addr,e),vt(t,e)}}function zg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;r.uniform3iv(this.addr,e),vt(t,e)}}function Hg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;r.uniform4iv(this.addr,e),vt(t,e)}}function Vg(r,e){const t=this.cache;t[0]!==e&&(r.uniform1ui(this.addr,e),t[0]=e)}function Gg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;r.uniform2uiv(this.addr,e),vt(t,e)}}function Wg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;r.uniform3uiv(this.addr,e),vt(t,e)}}function Xg(r,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;r.uniform4uiv(this.addr,e),vt(t,e)}}function qg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(tl.compareFunction=zl,s=tl):s=ph,t.setTexture2D(e||s,i)}function Yg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||gh,i)}function Kg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||_h,i)}function jg(r,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||mh,i)}function Zg(r){switch(r){case 5126:return Lg;case 35664:return Ig;case 35665:return Dg;case 35666:return Ng;case 35674:return Ug;case 35675:return Og;case 35676:return Fg;case 5124:case 35670:return Bg;case 35667:case 35671:return kg;case 35668:case 35672:return zg;case 35669:case 35673:return Hg;case 5125:return Vg;case 36294:return Gg;case 36295:return Wg;case 36296:return Xg;case 35678:case 36198:case 36298:case 36306:case 35682:return qg;case 35679:case 36299:case 36307:return Yg;case 35680:case 36300:case 36308:case 36293:return Kg;case 36289:case 36303:case 36311:case 36292:return jg}}function $g(r,e){r.uniform1fv(this.addr,e)}function Jg(r,e){const t=Qi(e,this.size,2);r.uniform2fv(this.addr,t)}function Qg(r,e){const t=Qi(e,this.size,3);r.uniform3fv(this.addr,t)}function e_(r,e){const t=Qi(e,this.size,4);r.uniform4fv(this.addr,t)}function t_(r,e){const t=Qi(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,t)}function n_(r,e){const t=Qi(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,t)}function i_(r,e){const t=Qi(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,t)}function s_(r,e){r.uniform1iv(this.addr,e)}function r_(r,e){r.uniform2iv(this.addr,e)}function o_(r,e){r.uniform3iv(this.addr,e)}function a_(r,e){r.uniform4iv(this.addr,e)}function c_(r,e){r.uniform1uiv(this.addr,e)}function l_(r,e){r.uniform2uiv(this.addr,e)}function h_(r,e){r.uniform3uiv(this.addr,e)}function u_(r,e){r.uniform4uiv(this.addr,e)}function f_(r,e,t){const n=this.cache,i=e.length,s=Rr(t,i);_t(n,s)||(r.uniform1iv(this.addr,s),vt(n,s));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||ph,s[o])}function d_(r,e,t){const n=this.cache,i=e.length,s=Rr(t,i);_t(n,s)||(r.uniform1iv(this.addr,s),vt(n,s));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||gh,s[o])}function p_(r,e,t){const n=this.cache,i=e.length,s=Rr(t,i);_t(n,s)||(r.uniform1iv(this.addr,s),vt(n,s));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||_h,s[o])}function m_(r,e,t){const n=this.cache,i=e.length,s=Rr(t,i);_t(n,s)||(r.uniform1iv(this.addr,s),vt(n,s));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||mh,s[o])}function g_(r){switch(r){case 5126:return $g;case 35664:return Jg;case 35665:return Qg;case 35666:return e_;case 35674:return t_;case 35675:return n_;case 35676:return i_;case 5124:case 35670:return s_;case 35667:case 35671:return r_;case 35668:case 35672:return o_;case 35669:case 35673:return a_;case 5125:return c_;case 36294:return l_;case 36295:return h_;case 36296:return u_;case 35678:case 36198:case 36298:case 36306:case 35682:return f_;case 35679:case 36299:case 36307:return d_;case 35680:case 36300:case 36308:case 36293:return p_;case 36289:case 36303:case 36311:case 36292:return m_}}class __{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Zg(t.type)}}class v_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=g_(t.type)}}class x_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let s=0,o=i.length;s!==o;++s){const a=i[s];a.setValue(e,t[a.id],n)}}}const po=/(\w+)(\])?(\[|\.)?/g;function al(r,e){r.seq.push(e),r.map[e.id]=e}function y_(r,e,t){const n=r.name,i=n.length;for(po.lastIndex=0;;){const s=po.exec(n),o=po.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===i){al(t,l===void 0?new __(a,r,e):new v_(a,r,e));break}else{let u=t.map[a];u===void 0&&(u=new x_(a),al(t,u)),t=u}}}class gr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=e.getActiveUniform(t,i),o=e.getUniformLocation(t,s.name);y_(s,o,this)}}setValue(e,t,n,i){const s=this.map[t];s!==void 0&&s.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let s=0,o=t.length;s!==o;++s){const a=t[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,s=e.length;i!==s;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function cl(r,e,t){const n=r.createShader(e);return r.shaderSource(n,t),r.compileShader(n),n}const M_=37297;let S_=0;function E_(r,e){const t=r.split(`
`),n=[],i=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=i;o<s;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const ll=new Fe;function T_(r){Ze._getMatrix(ll,Ze.workingColorSpace,r);const e=`mat3( ${ll.elements.map(t=>t.toFixed(4))} )`;switch(Ze.getTransfer(r)){case xr:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function hl(r,e,t){const n=r.getShaderParameter(e,r.COMPILE_STATUS),i=r.getShaderInfoLog(e).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+i+`

`+E_(r.getShaderSource(e),o)}else return i}function b_(r,e){const t=T_(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function A_(r,e){let t;switch(e){case nu:t="Linear";break;case iu:t="Reinhard";break;case su:t="Cineon";break;case ru:t="ACESFilmic";break;case au:t="AgX";break;case cu:t="Neutral";break;case ou:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+r+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const lr=new B;function w_(){Ze.getLuminanceCoefficients(lr);const r=lr.x.toFixed(4),e=lr.y.toFixed(4),t=lr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function R_(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(us).join(`
`)}function C_(r){const e=[];for(const t in r){const n=r[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function P_(r,e){const t={},n=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(e,i),o=s.name;let a=1;s.type===r.FLOAT_MAT2&&(a=2),s.type===r.FLOAT_MAT3&&(a=3),s.type===r.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:r.getAttribLocation(e,o),locationSize:a}}return t}function us(r){return r!==""}function ul(r,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function fl(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const L_=/^[ \t]*#include +<([\w\d./]+)>/gm;function fa(r){return r.replace(L_,D_)}const I_=new Map;function D_(r,e){let t=We[e];if(t===void 0){const n=I_.get(e);if(n!==void 0)t=We[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return fa(t)}const N_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function dl(r){return r.replace(N_,U_)}function U_(r,e,t,n){let i="";for(let s=parseInt(e);s<parseInt(t);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function pl(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}function O_(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===bl?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===Uh?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===yn&&(e="SHADOWMAP_TYPE_VSM"),e}function F_(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Fi:case Bi:e="ENVMAP_TYPE_CUBE";break;case Tr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function B_(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Bi:e="ENVMAP_MODE_REFRACTION";break}return e}function k_(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case Al:e="ENVMAP_BLENDING_MULTIPLY";break;case eu:e="ENVMAP_BLENDING_MIX";break;case tu:e="ENVMAP_BLENDING_ADD";break}return e}function z_(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function H_(r,e,t,n){const i=r.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=O_(t),l=F_(t),h=B_(t),u=k_(t),f=z_(t),p=R_(t),g=C_(s),_=i.createProgram();let m,d,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);const v=w+m+o,x=w+d+a,I=cl(i,i.VERTEX_SHADER,v),C=cl(i,i.FRAGMENT_SHADER,x);i.attachShader(_,I),i.attachShader(_,C),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function P(F){if(r.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),W=i.getShaderInfoLog(I).trim(),K=i.getShaderInfoLog(C).trim();let oe=!0,Z=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(oe=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,I,C);else{const ie=hl(i,I,"vertex"),k=hl(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function i0(r,e,t){let n=new wa;const i=new he,s=new he,o=new Qe,a=new Qf({depthPacking:du}),c=new ed,l={},h=t.maxTextureSize,u={[An]:Ot,[Ot]:An,[Qt]:Qt},f=new nn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new he},radius:{value:4}},vertexShader:t0,fragmentShader:n0}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const g=new St;g.setAttribute("position",new gt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new mt(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=bl;let d=this.type;this.render=function(C,P,U){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||C.length===0)return;const E=r.getRenderTarget(),M=r.getActiveCubeFace(),F=r.getActiveMipmapLevel(),z=r.state;z.setBlending(Tn),z.buffers.color.setClear(1,1,1,1),z.buffers.depth.setTest(!0),z.setScissorTest(!1);const W=d!==yn&&this.type===yn,K=d===yn&&this.type!==yn;for(let oe=0,Z=C.length;oe<Z;oe++){const ie=C[oe],k=ie.shadow;if(k===void 0){console.warn("THREE.WebGLShadowMap:",ie,"has no shadow.");continue}if(k.autoUpdate===!1&&k.needsUpdate===!1)continue;i.copy(k.mapSize);const pe=k.getFrameExtents();if(i.multiply(pe),s.copy(k.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(s.x=Math.floor(h/pe.x),i.x=s.x*pe.x,k.mapSize.x=s.x),i.y>h&&(s.y=Math.floor(h/pe.y),i.y=s.y*pe.y,k.mapSize.y=s.y)),k.map===null||W===!0||K===!0){const ye=this.type!==yn?{minFilter:Tt,magFilter:Tt}:{};k.map!==null&&k.map.dispose(),k.map=new zn(i.x,i.y,ye),k.map.texture.name=ie.name+".shadowMap",k.camera.updateProjectionMatrix()}r.setRenderTarget(k.map),r.clear();const _e=k.getViewportCount();for(let ye=0;ye<_e;ye++){const Ue=k.getViewport(ye);o.set(s.x*Ue.x,s.y*Ue.y,s.x*Ue.z,s.y*Ue.w),z.viewport(o),k.updateMatrices(ie,ye),n=k.getFrustum(),x(P,U,k.camera,ie,this.type)}k.isPointLightShadow!==!0&&this.type===yn&&w(k,U),k.needsUpdate=!1}d=this.type,m.needsUpdate=!1,r.setRenderTarget(E,M,F)};function w(C,P){const U=e.update(_);f.defines.VSM_SAMPLES!==C.blurSamples&&(f.defines.VSM_SAMPLES=C.blurSamples,p.defines.VSM_SAMPLES=C.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new zn(i.x,i.y)),f.uniforms.shadow_pass.value=C.map.texture,f.uniforms.resolution.value=C.mapSize,f.uniforms.radius.value=C.radius,r.setRenderTarget(C.mapPass),r.clear(),r.renderBufferDirect(P,null,U,f,_,null),p.uniforms.shadow_pass.value=C.mapPass.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,r.setRenderTarget(C.map),r.clear(),r.renderBufferDirect(P,null,U,p,_,null)}function v(C,P,U,E){let M=null;const F=U.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(F!==void 0)M=F;else if(M=U.isPointLight===!0?c:a,r.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0){const z=M.uuid,W=P.uuid;let K=l[z];K===void 0&&(K={},l[z]=K);let oe=K[W];oe===void 0&&(oe=M.clone(),K[W]=oe,P.addEventListener("dispose",I)),M=oe}if(M.visible=P.visible,M.wireframe=P.wireframe,E===yn?M.side=P.shadowSide!==null?P.shadowSide:P.side:M.side=P.shadowSide!==null?P.shadowSide:u[P.side],M.alphaMap=P.alphaMap,M.alphaTest=P.alphaTest,M.map=P.map,M.clipShadows=P.clipShadows,M.clippingPlanes=P.clippingPlanes,M.clipIntersection=P.clipIntersection,M.displacementMap=P.displacementMap,M.displacementScale=P.displacementScale,M.displacementBias=P.displacementBias,M.wireframeLinewidth=P.wireframeLinewidth,M.linewidth=P.linewidth,U.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const z=r.properties.get(M);z.light=U}return M}function x(C,P,U,E,M){if(C.visible===!1)return;if(C.layers.test(P.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&M===yn)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(U.matrixWorldInverse,C.matrixWorld);const W=e.update(C),K=C.material;if(Array.isArray(K)){const oe=W.groups;for(let Z=0,ie=oe.length;Z<ie;Z++){const k=oe[Z],pe=K[k.materialIndex];if(pe&&pe.visible){const _e=v(C,pe,E,M);C.onBeforeShadow(r,C,P,U,W,_e,k),r.renderBufferDirect(U,null,W,_e,C,k),C.onAfterShadow(r,C,P,U,W,_e,k)}}}else if(K.visible){const oe=v(C,K,E,M);C.onBeforeShadow(r,C,P,U,W,oe,null),r.renderBufferDirect(U,null,W,oe,C,null),C.onAfterShadow(r,C,P,U,W,oe,null)}}const z=C.children;for(let W=0,K=z.length;W<K;W++)x(z[W],P,U,E,M)}function I(C){C.target.removeEventListener("dispose",I);for(const U in l){const E=l[U],M=C.target.uuid;M in E&&(E[M].dispose(),delete E[M])}}}const s0={[So]:Eo,[To]:wo,[bo]:Ro,[Oi]:Ao,[Eo]:So,[wo]:To,[Ro]:bo,[Ao]:Oi};function r0(r,e){function t(){let H=!1;const Me=new Qe;let re=null;const fe=new Qe(0,0,0,0);return{setMask:function(be){re!==be&&!H&&(r.colorMask(be,be,be,be),re=be)},setLocked:function(be){H=be},setClear:function(be,Te,Ve,ht,bt){bt===!0&&(be*=ht,Te*=ht,Ve*=ht),Me.set(be,Te,Ve,ht),fe.equals(Me)===!1&&(r.clearColor(be,Te,Ve,ht),fe.copy(Me))},reset:function(){H=!1,re=null,fe.set(-1,0,0,0)}}}function n(){let H=!1,Me=!1,re=null,fe=null,be=null;return{setReversed:function(Te){if(Me!==Te){const Ve=e.get("EXT_clip_control");Me?Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.ZERO_TO_ONE_EXT):Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.NEGATIVE_ONE_TO_ONE_EXT);const ht=be;be=null,this.setClear(ht)}Me=Te},getReversed:function(){return Me},setTest:function(Te){Te?T(r.DEPTH_TEST):j(r.DEPTH_TEST)},setMask:function(Te){re!==Te&&!H&&(r.depthMask(Te),re=Te)},setFunc:function(Te){if(Me&&(Te=s0[Te]),fe!==Te){switch(Te){case So:r.depthFunc(r.NEVER);break;case Eo:r.depthFunc(r.ALWAYS);break;case To:r.depthFunc(r.LESS);break;case Oi:r.depthFunc(r.LEQUAL);break;case bo:r.depthFunc(r.EQUAL);break;case Ao:r.depthFunc(r.GEQUAL);break;case wo:r.depthFunc(r.GREATER);break;case Ro:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}fe=Te}},setLocked:function(Te){H=Te},setClear:function(Te){be!==Te&&(Me&&(Te=1-Te),r.clearDepth(Te),be=Te)},reset:function(){H=!1,re=null,fe=null,be=null,Me=!1}}}function i(){let H=!1,Me=null,re=null,fe=null,be=null,Te=null,Ve=null,ht=null,bt=null;return{setTest:function(nt){H||(nt?T(r.STENCIL_TEST):j(r.STENCIL_TEST))},setMask:function(nt){Me!==nt&&!H&&(r.stencilMask(nt),Me=nt)},setFunc:function(nt,Kt,dn){(re!==nt||fe!==Kt||be!==dn)&&(r.stencilFunc(nt,Kt,dn),re=nt,fe=Kt,be=dn)},setOp:function(nt,Kt,dn){(Te!==nt||Ve!==Kt||ht!==dn)&&(r.stencilOp(nt,Kt,dn),Te=nt,Ve=Kt,ht=dn)},setLocked:function(nt){H=nt},setClear:function(nt){bt!==nt&&(r.clearStencil(nt),bt=nt)},reset:function(){H=!1,Me=null,re=null,fe=null,be=null,Te=null,Ve=null,ht=null,bt=null}}}const s=new t,o=new n,a=new i,c=new WeakMap,l=new WeakMap;let h={},u={},f=new WeakMap,p=[],g=null,_=!1,m=null,d=null,w=null,v=null,x=null,I=null,C=null,P=new Le(0,0,0),U=0,E=!1,M=null,F=null,z=null,W=null,K=null;const oe=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Z=!1,ie=0;const k=r.getParameter(r.VERSION);k.indexOf("WebGL")!==-1?(ie=parseFloat(/^WebGL (\d)/.exec(k)[1]),Z=ie>=1):k.indexOf("OpenGL ES")!==-1&&(ie=parseFloat(/^OpenGL ES (\d)/.exec(k)[1]),Z=ie>=2);let pe=null,_e={};const ye=r.getParameter(r.SCISSOR_BOX),Ue=r.getParameter(r.VIEWPORT),Ye=new Qe().fromArray(ye),N=new Qe().fromArray(Ue);function D(H,Me,re,fe){const be=new Uint8Array(4),Te=r.createTexture();r.bindTexture(H,Te),r.texParameteri(H,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(H,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Ve=0;Ve<re;Ve++)H===r.TEXTURE_3D||H===r.TEXTURE_2D_ARRAY?r.texImage3D(Me,0,r.RGBA,1,1,fe,0,r.RGBA,r.UNSIGNED_BYTE,be):r.texImage2D(Me+Ve,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,be);return Te}const R={};R[r.TEXTURE_2D]=D(r.TEXTURE_2D,r.TEXTURE_2D,1),R[r.TEXTURE_CUBE_MAP]=D(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),R[r.TEXTURE_2D_ARRAY]=D(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),R[r.TEXTURE_3D]=D(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),T(r.DEPTH_TEST),o.setFunc(Oi),$(!1),ae(qa),T(r.CULL_FACE),y(Tn);function T(H){h[H]!==!0&&(r.enable(H),h[H]=!0)}function j(H){h[H]!==!1&&(r.disable(H),h[H]=!1)}function ce(H,Me){return u[H]!==Me?(r.bindFramebuffer(H,Me),u[H]=Me,H===r.DRAW_FRAMEBUFFER&&(u[r.FRAMEBUFFER]=Me),H===r.FRAMEBUFFER&&(u[r.DRAW_FRAMEBUFFER]=Me),!0):!1}function q(H,Me){let re=p,fe=!1;if(H){re=f.get(Me),re===void 0&&(re=[],f.set(Me,re));const be=H.textures;if(re.length!==be.length||re[0]!==r.COLOR_ATTACHMENT0){for(let Te=0,Ve=be.length;Te<Ve;Te++)re[Te]=r.COLOR_ATTACHMENT0+Te;re.length=be.length,fe=!0}}else re[0]!==r.BACK&&(re[0]=r.BACK,fe=!0);fe&&r.drawBuffers(re)}function de(H){return g!==H?(r.useProgram(H),g=H,!0):!1}const X={[ei]:r.FUNC_ADD,[Fh]:r.FUNC_SUBTRACT,[Bh]:r.FUNC_REVERSE_SUBTRACT};X[kh]=r.MIN,X[zh]=r.MAX;const J={[Hh]:r.ZERO,[Vh]:r.ONE,[Gh]:r.SRC_COLOR,[yo]:r.SRC_ALPHA,[jh]:r.SRC_ALPHA_SATURATE,[Yh]:r.DST_COLOR,[Xh]:r.DST_ALPHA,[Wh]:r.ONE_MINUS_SRC_COLOR,[Mo]:r.ONE_MINUS_SRC_ALPHA,[Kh]:r.ONE_MINUS_DST_COLOR,[qh]:r.ONE_MINUS_DST_ALPHA,[Zh]:r.CONSTANT_COLOR,[$h]:r.ONE_MINUS_CONSTANT_COLOR,[Jh]:r.CONSTANT_ALPHA,[Qh]:r.ONE_MINUS_CONSTANT_ALPHA};function y(H,Me,re,fe,be,Te,Ve,ht,bt,nt){if(H===Tn){_===!0&&(j(r.BLEND),_=!1);return}if(_===!1&&(T(r.BLEND),_=!0),H!==Oh){if(H!==m||nt!==E){if((d!==ei||x!==ei)&&(r.blendEquation(r.FUNC_ADD),d=ei,x=ei),nt)switch(H){case Bn:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ya:r.blendFunc(r.ONE,r.ONE);break;case Ka:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case ja:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}else switch(H){case Bn:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ya:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case Ka:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case ja:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",H);break}w=null,v=null,I=null,C=null,P.set(0,0,0),U=0,m=H,E=nt}return}be=be||Me,Te=Te||re,Ve=Ve||fe,(Me!==d||be!==x)&&(r.blendEquationSeparate(X[Me],X[be]),d=Me,x=be),(re!==w||fe!==v||Te!==I||Ve!==C)&&(r.blendFuncSeparate(J[re],J[fe],J[Te],J[Ve]),w=re,v=fe,I=Te,C=Ve),(ht.equals(P)===!1||bt!==U)&&(r.blendColor(ht.r,ht.g,ht.b,bt),P.copy(ht),U=bt),m=H,E=!1}function te(H,Me){H.side===Qt?j(r.CULL_FACE):T(r.CULL_FACE);let re=H.side===Ot;Me&&(re=!re),$(re),H.blending===Bn&&H.transparent===!1?y(Tn):y(H.blending,H.blendEquation,H.blendSrc,H.blendDst,H.blendEquationAlpha,H.blendSrcAlpha,H.blendDstAlpha,H.blendColor,H.blendAlpha,H.premultipliedAlpha),o.setFunc(H.depthFunc),o.setTest(H.depthTest),o.setMask(H.depthWrite),s.setMask(H.colorWrite);const fe=H.stencilWrite;a.setTest(fe),fe&&(a.setMask(H.stencilWriteMask),a.setFunc(H.stencilFunc,H.stencilRef,H.stencilFuncMask),a.setOp(H.stencilFail,H.stencilZFail,H.stencilZPass)),L(H.polygonOffset,H.polygonOffsetFactor,H.polygonOffsetUnits),H.alphaToCoverage===!0?T(r.SAMPLE_ALPHA_TO_COVERAGE):j(r.SAMPLE_ALPHA_TO_COVERAGE)}function $(H){M!==H&&(H?r.frontFace(r.CW):r.frontFace(r.CCW),M=H)}function ae(H){H!==Dh?(T(r.CULL_FACE),H!==F&&(H===qa?r.cullFace(r.BACK):H===Nh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):j(r.CULL_FACE),F=H}function O(H){H!==z&&(Z&&r.lineWidth(H),z=H)}function L(H,Me,re){H?(T(r.POLYGON_OFFSET_FILL),(W!==Me||K!==re)&&(r.polygonOffset(Me,re),W=Me,K=re)):j(r.POLYGON_OFFSET_FILL)}function se(H){H?T(r.SCISSOR_TEST):j(r.SCISSOR_TEST)}function A(H){H===void 0&&(H=r.TEXTURE0+oe-1),pe!==H&&(r.activeTexture(H),pe=H)}function S(H,Me,re){re===void 0&&(pe===null?re=r.TEXTURE0+oe-1:re=pe);let fe=_e[re];fe===void 0&&(fe={type:void 0,texture:void 0},_e[re]=fe),(fe.type!==H||fe.texture!==Me)&&(pe!==re&&(r.activeTexture(re),pe=re),r.bindTexture(H,Me||R[H]),fe.type=H,fe.texture=Me)}function Y(){const H=_e[pe];H!==void 0&&H.type!==void 0&&(r.bindTexture(H.type,null),H.type=void 0,H.texture=void 0)}function ne(){try{r.compressedTexImage2D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ue(){try{r.compressedTexImage3D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function le(){try{r.texSubImage2D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Pe(){try{r.texSubImage3D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function ve(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Ee(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function He(){try{r.texStorage2D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function me(){try{r.texStorage3D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Ae(){try{r.texImage2D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function De(){try{r.texImage3D.apply(r,arguments)}catch(H){console.error("THREE.WebGLState:",H)}}function Oe(H){Ye.equals(H)===!1&&(r.scissor(H.x,H.y,H.z,H.w),Ye.copy(H))}function Re(H){N.equals(H)===!1&&(r.viewport(H.x,H.y,H.z,H.w),N.copy(H))}function Ke(H,Me){let re=l.get(Me);re===void 0&&(re=new WeakMap,l.set(Me,re));let fe=re.get(H);fe===void 0&&(fe=r.getUniformBlockIndex(Me,H.name),re.set(H,fe))}function Ge(H,Me){const fe=l.get(Me).get(H);c.get(Me)!==fe&&(r.uniformBlockBinding(Me,fe,H.__bindingPointIndex),c.set(Me,fe))}function ot(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),h={},pe=null,_e={},u={},f=new WeakMap,p=[],g=null,_=!1,m=null,d=null,w=null,v=null,x=null,I=null,C=null,P=new Le(0,0,0),U=0,E=!1,M=null,F=null,z=null,W=null,K=null,Ye.set(0,0,r.canvas.width,r.canvas.height),N.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:T,disable:j,bindFramebuffer:ce,drawBuffers:q,useProgram:de,setBlending:y,setMaterial:te,setFlipSided:$,setCullFace:ae,setLineWidth:O,setPolygonOffset:L,setScissorTest:se,activeTexture:A,bindTexture:S,unbindTexture:Y,compressedTexImage2D:ne,compressedTexImage3D:ue,texImage2D:Ae,texImage3D:De,updateUBOMapping:Ke,uniformBlockBinding:Ge,texStorage2D:He,texStorage3D:me,texSubImage2D:le,texSubImage3D:Pe,compressedTexSubImage2D:ve,compressedTexSubImage3D:Ee,scissor:Oe,viewport:Re,reset:ot}}function o0(r,e,t,n,i,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new he,h=new WeakMap;let u;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,S){return p?new OffscreenCanvas(A,S):ys("canvas")}function _(A,S,Y){let ne=1;const ue=se(A);if((ue.width>Y||ue.height>Y)&&(ne=Y/Math.max(ue.width,ue.height)),ne<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const le=Math.floor(ne*ue.width),Pe=Math.floor(ne*ue.height);u===void 0&&(u=g(le,Pe));const ve=S?g(le,Pe):u;return ve.width=le,ve.height=Pe,ve.getContext("2d").drawImage(A,0,0,le,Pe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ue.width+"x"+ue.height+") to ("+le+"x"+Pe+")."),ve}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ue.width+"x"+ue.height+")."),A;return A}function m(A){return A.generateMipmaps}function d(A){r.generateMipmap(A)}function w(A){return A.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?r.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function v(A,S,Y,ne,ue=!1){if(A!==null){if(r[A]!==void 0)return r[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let le=S;if(S===r.RED&&(Y===r.FLOAT&&(le=r.R32F),Y===r.HALF_FLOAT&&(le=r.R16F),Y===r.UNSIGNED_BYTE&&(le=r.R8)),S===r.RED_INTEGER&&(Y===r.UNSIGNED_BYTE&&(le=r.R8UI),Y===r.UNSIGNED_SHORT&&(le=r.R16UI),Y===r.UNSIGNED_INT&&(le=r.R32UI),Y===r.BYTE&&(le=r.R8I),Y===r.SHORT&&(le=r.R16I),Y===r.INT&&(le=r.R32I)),S===r.RG&&(Y===r.FLOAT&&(le=r.RG32F),Y===r.HALF_FLOAT&&(le=r.RG16F),Y===r.UNSIGNED_BYTE&&(le=r.RG8)),S===r.RG_INTEGER&&(Y===r.UNSIGNED_BYTE&&(le=r.RG8UI),Y===r.UNSIGNED_SHORT&&(le=r.RG16UI),Y===r.UNSIGNED_INT&&(le=r.RG32UI),Y===r.BYTE&&(le=r.RG8I),Y===r.SHORT&&(le=r.RG16I),Y===r.INT&&(le=r.RG32I)),S===r.RGB_INTEGER&&(Y===r.UNSIGNED_BYTE&&(le=r.RGB8UI),Y===r.UNSIGNED_SHORT&&(le=r.RGB16UI),Y===r.UNSIGNED_INT&&(le=r.RGB32UI),Y===r.BYTE&&(le=r.RGB8I),Y===r.SHORT&&(le=r.RGB16I),Y===r.INT&&(le=r.RGB32I)),S===r.RGBA_INTEGER&&(Y===r.UNSIGNED_BYTE&&(le=r.RGBA8UI),Y===r.UNSIGNED_SHORT&&(le=r.RGBA16UI),Y===r.UNSIGNED_INT&&(le=r.RGBA32UI),Y===r.BYTE&&(le=r.RGBA8I),Y===r.SHORT&&(le=r.RGBA16I),Y===r.INT&&(le=r.RGBA32I)),S===r.RGB&&Y===r.UNSIGNED_INT_5_9_9_9_REV&&(le=r.RGB9_E5),S===r.RGBA){const Pe=ue?xr:Ze.getTransfer(ne);Y===r.FLOAT&&(le=r.RGBA32F),Y===r.HALF_FLOAT&&(le=r.RGBA16F),Y===r.UNSIGNED_BYTE&&(le=Pe===rt?r.SRGB8_ALPHA8:r.RGBA8),Y===r.UNSIGNED_SHORT_4_4_4_4&&(le=r.RGBA4),Y===r.UNSIGNED_SHORT_5_5_5_1&&(le=r.RGB5_A1)}return(le===r.R16F||le===r.R32F||le===r.RG16F||le===r.RG32F||le===r.RGBA16F||le===r.RGBA32F)&&e.get("EXT_color_buffer_float"),le}function x(A,S){let Y;return A?S===null||S===ai||S===zi?Y=r.DEPTH24_STENCIL8:S===tn?Y=r.DEPTH32F_STENCIL8:S===_s&&(Y=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===ai||S===zi?Y=r.DEPTH_COMPONENT24:S===tn?Y=r.DEPTH_COMPONENT32F:S===_s&&(Y=r.DEPTH_COMPONENT16),Y}function I(A,S){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==Tt&&A.minFilter!==It?Math.log2(Math.max(S.width,S.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?S.mipmaps.length:1}function C(A){const S=A.target;S.removeEventListener("dispose",C),U(S),S.isVideoTexture&&h.delete(S)}function P(A){const S=A.target;S.removeEventListener("dispose",P),M(S)}function U(A){const S=n.get(A);if(S.__webglInit===void 0)return;const Y=A.source,ne=f.get(Y);if(ne){const ue=ne[S.__cacheKey];ue.usedTimes--,ue.usedTimes===0&&E(A),Object.keys(ne).length===0&&f.delete(Y)}n.remove(A)}function E(A){const S=n.get(A);r.deleteTexture(S.__webglTexture);const Y=A.source,ne=f.get(Y);delete ne[S.__cacheKey],o.memory.textures--}function M(A){const S=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let ne=0;ne<6;ne++){if(Array.isArray(S.__webglFramebuffer[ne]))for(let ue=0;ue<S.__webglFramebuffer[ne].length;ue++)r.deleteFramebuffer(S.__webglFramebuffer[ne][ue]);else r.deleteFramebuffer(S.__webglFramebuffer[ne]);S.__webglDepthbuffer&&r.deleteRenderbuffer(S.__webglDepthbuffer[ne])}else{if(Array.isArray(S.__webglFramebuffer))for(let ne=0;ne<S.__webglFramebuffer.length;ne++)r.deleteFramebuffer(S.__webglFramebuffer[ne]);else r.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&r.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&r.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let ne=0;ne<S.__webglColorRenderbuffer.length;ne++)S.__webglColorRenderbuffer[ne]&&r.deleteRenderbuffer(S.__webglColorRenderbuffer[ne]);S.__webglDepthRenderbuffer&&r.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const Y=A.textures;for(let ne=0,ue=Y.length;ne<ue;ne++){const le=n.get(Y[ne]);le.__webglTexture&&(r.deleteTexture(le.__webglTexture),o.memory.textures--),n.remove(Y[ne])}n.remove(A)}let F=0;function z(){F=0}function W(){const A=F;return A>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),F+=1,A}function K(A){const S=[];return S.push(A.wrapS),S.push(A.wrapT),S.push(A.wrapR||0),S.push(A.magFilter),S.push(A.minFilter),S.push(A.anisotropy),S.push(A.internalFormat),S.push(A.format),S.push(A.type),S.push(A.generateMipmaps),S.push(A.premultiplyAlpha),S.push(A.flipY),S.push(A.unpackAlignment),S.push(A.colorSpace),S.join()}function oe(A,S){const Y=n.get(A);if(A.isVideoTexture&&O(A),A.isRenderTargetTexture===!1&&A.version>0&&Y.__version!==A.version){const ne=A.image;if(ne===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ne.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{N(Y,A,S);return}}t.bindTexture(r.TEXTURE_2D,Y.__webglTexture,r.TEXTURE0+S)}function Z(A,S){const Y=n.get(A);if(A.version>0&&Y.__version!==A.version){N(Y,A,S);return}t.bindTexture(r.TEXTURE_2D_ARRAY,Y.__webglTexture,r.TEXTURE0+S)}function ie(A,S){const Y=n.get(A);if(A.version>0&&Y.__version!==A.version){N(Y,A,S);return}t.bindTexture(r.TEXTURE_3D,Y.__webglTexture,r.TEXTURE0+S)}function k(A,S){const Y=n.get(A);if(A.version>0&&Y.__version!==A.version){D(Y,A,S);return}t.bindTexture(r.TEXTURE_CUBE_MAP,Y.__webglTexture,r.TEXTURE0+S)}const pe={[ki]:r.REPEAT,[On]:r.CLAMP_TO_EDGE,[vr]:r.MIRRORED_REPEAT},_e={[Tt]:r.NEAREST,[Rl]:r.NEAREST_MIPMAP_NEAREST,[hs]:r.NEAREST_MIPMAP_LINEAR,[It]:r.LINEAR,[hr]:r.LINEAR_MIPMAP_NEAREST,[Sn]:r.LINEAR_MIPMAP_LINEAR},ye={[mu]:r.NEVER,[Mu]:r.ALWAYS,[gu]:r.LESS,[zl]:r.LEQUAL,[_u]:r.EQUAL,[yu]:r.GEQUAL,[vu]:r.GREATER,[xu]:r.NOTEQUAL};function Ue(A,S){if(S.type===tn&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===It||S.magFilter===hr||S.magFilter===hs||S.magFilter===Sn||S.minFilter===It||S.minFilter===hr||S.minFilter===hs||S.minFilter===Sn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(A,r.TEXTURE_WRAP_S,pe[S.wrapS]),r.texParameteri(A,r.TEXTURE_WRAP_T,pe[S.wrapT]),(A===r.TEXTURE_3D||A===r.TEXTURE_2D_ARRAY)&&r.texParameteri(A,r.TEXTURE_WRAP_R,pe[S.wrapR]),r.texParameteri(A,r.TEXTURE_MAG_FILTER,_e[S.magFilter]),r.texParameteri(A,r.TEXTURE_MIN_FILTER,_e[S.minFilter]),S.compareFunction&&(r.texParameteri(A,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(A,r.TEXTURE_COMPARE_FUNC,ye[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Tt||S.minFilter!==hs&&S.minFilter!==Sn||S.type===tn&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");r.texParameterf(A,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,i.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function Ye(A,S){let Y=!1;A.__webglInit===void 0&&(A.__webglInit=!0,S.addEventListener("dispose",C));const ne=S.source;let ue=f.get(ne);ue===void 0&&(ue={},f.set(ne,ue));const le=K(S);if(le!==A.__cacheKey){ue[le]===void 0&&(ue[le]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,Y=!0),ue[le].usedTimes++;const Pe=ue[A.__cacheKey];Pe!==void 0&&(ue[A.__cacheKey].usedTimes--,Pe.usedTimes===0&&E(S)),A.__cacheKey=le,A.__webglTexture=ue[le].texture}return Y}function N(A,S,Y){let ne=r.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(ne=r.TEXTURE_2D_ARRAY),S.isData3DTexture&&(ne=r.TEXTURE_3D);const ue=Ye(A,S),le=S.source;t.bindTexture(ne,A.__webglTexture,r.TEXTURE0+Y);const Pe=n.get(le);if(le.version!==Pe.__version||ue===!0){t.activeTexture(r.TEXTURE0+Y);const ve=Ze.getPrimaries(Ze.workingColorSpace),Ee=S.colorSpace===Un?null:Ze.getPrimaries(S.colorSpace),He=S.colorSpace===Un||ve===Ee?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,S.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,S.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,He);let me=_(S.image,!1,i.maxTextureSize);me=L(S,me);const Ae=s.convert(S.format,S.colorSpace),De=s.convert(S.type);let Oe=v(S.internalFormat,Ae,De,S.colorSpace,S.isVideoTexture);Ue(ne,S);let Re;const Ke=S.mipmaps,Ge=S.isVideoTexture!==!0,ot=Pe.__version===void 0||ue===!0,H=le.dataReady,Me=I(S,me);if(S.isDepthTexture)Oe=x(S.format===Hi,S.type),ot&&(Ge?t.texStorage2D(r.TEXTURE_2D,1,Oe,me.width,me.height):t.texImage2D(r.TEXTURE_2D,0,Oe,me.width,me.height,0,Ae,De,null));else if(S.isDataTexture)if(Ke.length>0){Ge&&ot&&t.texStorage2D(r.TEXTURE_2D,Me,Oe,Ke[0].width,Ke[0].height);for(let re=0,fe=Ke.length;re<fe;re++)Re=Ke[re],Ge?H&&t.texSubImage2D(r.TEXTURE_2D,re,0,0,Re.width,Re.height,Ae,De,Re.data):t.texImage2D(r.TEXTURE_2D,re,Oe,Re.width,Re.height,0,Ae,De,Re.data);S.generateMipmaps=!1}else Ge?(ot&&t.texStorage2D(r.TEXTURE_2D,Me,Oe,me.width,me.height),H&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,me.width,me.height,Ae,De,me.data)):t.texImage2D(r.TEXTURE_2D,0,Oe,me.width,me.height,0,Ae,De,me.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){Ge&&ot&&t.texStorage3D(r.TEXTURE_2D_ARRAY,Me,Oe,Ke[0].width,Ke[0].height,me.depth);for(let re=0,fe=Ke.length;re<fe;re++)if(Re=Ke[re],S.format!==qt)if(Ae!==null)if(Ge){if(H)if(S.layerUpdates.size>0){const be=Yc(Re.width,Re.height,S.format,S.type);for(const Te of S.layerUpdates){const Ve=Re.data.subarray(Te*be/Re.data.BYTES_PER_ELEMENT,(Te+1)*be/Re.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,re,0,0,Te,Re.width,Re.height,1,Ae,Ve)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,re,0,0,0,Re.width,Re.height,me.depth,Ae,Re.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,re,Oe,Re.width,Re.height,me.depth,0,Re.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?H&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,re,0,0,0,Re.width,Re.height,me.depth,Ae,De,Re.data):t.texImage3D(r.TEXTURE_2D_ARRAY,re,Oe,Re.width,Re.height,me.depth,0,Ae,De,Re.data)}else{Ge&&ot&&t.texStorage2D(r.TEXTURE_2D,Me,Oe,Ke[0].width,Ke[0].height);for(let re=0,fe=Ke.length;re<fe;re++)Re=Ke[re],S.format!==qt?Ae!==null?Ge?H&&t.compressedTexSubImage2D(r.TEXTURE_2D,re,0,0,Re.width,Re.height,Ae,Re.data):t.compressedTexImage2D(r.TEXTURE_2D,re,Oe,Re.width,Re.height,0,Re.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?H&&t.texSubImage2D(r.TEXTURE_2D,re,0,0,Re.width,Re.height,Ae,De,Re.data):t.texImage2D(r.TEXTURE_2D,re,Oe,Re.width,Re.height,0,Ae,De,Re.data)}else if(S.isDataArrayTexture)if(Ge){if(ot&&t.texStorage3D(r.TEXTURE_2D_ARRAY,Me,Oe,me.width,me.height,me.depth),H)if(S.layerUpdates.size>0){const re=Yc(me.width,me.height,S.format,S.type);for(const fe of S.layerUpdates){const be=me.data.subarray(fe*re/me.data.BYTES_PER_ELEMENT,(fe+1)*re/me.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,fe,me.width,me.height,1,Ae,De,be)}S.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,me.width,me.height,me.depth,Ae,De,me.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Oe,me.width,me.height,me.depth,0,Ae,De,me.data);else if(S.isData3DTexture)Ge?(ot&&t.texStorage3D(r.TEXTURE_3D,Me,Oe,me.width,me.height,me.depth),H&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,me.width,me.height,me.depth,Ae,De,me.data)):t.texImage3D(r.TEXTURE_3D,0,Oe,me.width,me.height,me.depth,0,Ae,De,me.data);else if(S.isFramebufferTexture){if(ot)if(Ge)t.texStorage2D(r.TEXTURE_2D,Me,Oe,me.width,me.height);else{let re=me.width,fe=me.height;for(let be=0;be<Me;be++)t.texImage2D(r.TEXTURE_2D,be,Oe,re,fe,0,Ae,De,null),re>>=1,fe>>=1}}else if(Ke.length>0){if(Ge&&ot){const re=se(Ke[0]);t.texStorage2D(r.TEXTURE_2D,Me,Oe,re.width,re.height)}for(let re=0,fe=Ke.length;re<fe;re++)Re=Ke[re],Ge?H&&t.texSubImage2D(r.TEXTURE_2D,re,0,0,Ae,De,Re):t.texImage2D(r.TEXTURE_2D,re,Oe,Ae,De,Re);S.generateMipmaps=!1}else if(Ge){if(ot){const re=se(me);t.texStorage2D(r.TEXTURE_2D,Me,Oe,re.width,re.height)}H&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,Ae,De,me)}else t.texImage2D(r.TEXTURE_2D,0,Oe,Ae,De,me);m(S)&&d(ne),Pe.__version=le.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function D(A,S,Y){if(S.image.length!==6)return;const ne=Ye(A,S),ue=S.source;t.bindTexture(r.TEXTURE_CUBE_MAP,A.__webglTexture,r.TEXTURE0+Y);const le=n.get(ue);if(ue.version!==le.__version||ne===!0){t.activeTexture(r.TEXTURE0+Y);const Pe=Ze.getPrimaries(Ze.workingColorSpace),ve=S.colorSpace===Un?null:Ze.getPrimaries(S.colorSpace),Ee=S.colorSpace===Un||Pe===ve?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,S.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,S.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const He=S.isCompressedTexture||S.image[0].isCompressedTexture,me=S.image[0]&&S.image[0].isDataTexture,Ae=[];for(let fe=0;fe<6;fe++)!He&&!me?Ae[fe]=_(S.image[fe],!0,i.maxCubemapSize):Ae[fe]=me?S.image[fe].image:S.image[fe],Ae[fe]=L(S,Ae[fe]);const De=Ae[0],Oe=s.convert(S.format,S.colorSpace),Re=s.convert(S.type),Ke=v(S.internalFormat,Oe,Re,S.colorSpace),Ge=S.isVideoTexture!==!0,ot=le.__version===void 0||ne===!0,H=ue.dataReady;let Me=I(S,De);Ue(r.TEXTURE_CUBE_MAP,S);let re;if(He){Ge&&ot&&t.texStorage2D(r.TEXTURE_CUBE_MAP,Me,Ke,De.width,De.height);for(let fe=0;fe<6;fe++){re=Ae[fe].mipmaps;for(let be=0;be<re.length;be++){const Te=re[be];S.format!==qt?Oe!==null?Ge?H&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be,0,0,Te.width,Te.height,Oe,Te.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be,Ke,Te.width,Te.height,0,Te.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ge?H&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be,0,0,Te.width,Te.height,Oe,Re,Te.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be,Ke,Te.width,Te.height,0,Oe,Re,Te.data)}}}else{if(re=S.mipmaps,Ge&&ot){re.length>0&&Me++;const fe=se(Ae[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,Me,Ke,fe.width,fe.height)}for(let fe=0;fe<6;fe++)if(me){Ge?H&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,Ae[fe].width,Ae[fe].height,Oe,Re,Ae[fe].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,Ke,Ae[fe].width,Ae[fe].height,0,Oe,Re,Ae[fe].data);for(let be=0;be<re.length;be++){const Ve=re[be].image[fe].image;Ge?H&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be+1,0,0,Ve.width,Ve.height,Oe,Re,Ve.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be+1,Ke,Ve.width,Ve.height,0,Oe,Re,Ve.data)}}else{Ge?H&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,0,0,Oe,Re,Ae[fe]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0,Ke,Oe,Re,Ae[fe]);for(let be=0;be<re.length;be++){const Te=re[be];Ge?H&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be+1,0,0,Oe,Re,Te.image[fe]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,be+1,Ke,Oe,Re,Te.image[fe])}}}m(S)&&d(r.TEXTURE_CUBE_MAP),le.__version=ue.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function R(A,S,Y,ne,ue,le){const Pe=s.convert(Y.format,Y.colorSpace),ve=s.convert(Y.type),Ee=v(Y.internalFormat,Pe,ve,Y.colorSpace),He=n.get(S),me=n.get(Y);if(me.__renderTarget=S,!He.__hasExternalTextures){const Ae=Math.max(1,S.width>>le),De=Math.max(1,S.height>>le);ue===r.TEXTURE_3D||ue===r.TEXTURE_2D_ARRAY?t.texImage3D(ue,le,Ee,Ae,De,S.depth,0,Pe,ve,null):t.texImage2D(ue,le,Ee,Ae,De,0,Pe,ve,null)}t.bindFramebuffer(r.FRAMEBUFFER,A),ae(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ne,ue,me.__webglTexture,0,$(S)):(ue===r.TEXTURE_2D||ue>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&ue<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,ne,ue,me.__webglTexture,le),t.bindFramebuffer(r.FRAMEBUFFER,null)}function T(A,S,Y){if(r.bindRenderbuffer(r.RENDERBUFFER,A),S.depthBuffer){const ne=S.depthTexture,ue=ne&&ne.isDepthTexture?ne.type:null,le=x(S.stencilBuffer,ue),Pe=S.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ve=$(S);ae(S)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ve,le,S.width,S.height):Y?r.renderbufferStorageMultisample(r.RENDERBUFFER,ve,le,S.width,S.height):r.renderbufferStorage(r.RENDERBUFFER,le,S.width,S.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Pe,r.RENDERBUFFER,A)}else{const ne=S.textures;for(let ue=0;ue<ne.length;ue++){const le=ne[ue],Pe=s.convert(le.format,le.colorSpace),ve=s.convert(le.type),Ee=v(le.internalFormat,Pe,ve,le.colorSpace),He=$(S);Y&&ae(S)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,He,Ee,S.width,S.height):ae(S)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,He,Ee,S.width,S.height):r.renderbufferStorage(r.RENDERBUFFER,Ee,S.width,S.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function j(A,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,A),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ne=n.get(S.depthTexture);ne.__renderTarget=S,(!ne.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),oe(S.depthTexture,0);const ue=ne.__webglTexture,le=$(S);if(S.depthTexture.format===Ci)ae(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,ue,0,le):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,ue,0);else if(S.depthTexture.format===Hi)ae(S)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,ue,0,le):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,ue,0);else throw new Error("Unknown depthTexture format")}function ce(A){const S=n.get(A),Y=A.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==A.depthTexture){const ne=A.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),ne){const ue=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,ne.removeEventListener("dispose",ue)};ne.addEventListener("dispose",ue),S.__depthDisposeCallback=ue}S.__boundDepthTexture=ne}if(A.depthTexture&&!S.__autoAllocateDepthBuffer){if(Y)throw new Error("target.depthTexture not supported in Cube render targets");j(S.__webglFramebuffer,A)}else if(Y){S.__webglDepthbuffer=[];for(let ne=0;ne<6;ne++)if(t.bindFramebuffer(r.FRAMEBUFFER,S.__webglFramebuffer[ne]),S.__webglDepthbuffer[ne]===void 0)S.__webglDepthbuffer[ne]=r.createRenderbuffer(),T(S.__webglDepthbuffer[ne],A,!1);else{const ue=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,le=S.__webglDepthbuffer[ne];r.bindRenderbuffer(r.RENDERBUFFER,le),r.framebufferRenderbuffer(r.FRAMEBUFFER,ue,r.RENDERBUFFER,le)}}else if(t.bindFramebuffer(r.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=r.createRenderbuffer(),T(S.__webglDepthbuffer,A,!1);else{const ne=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ue=S.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ue),r.framebufferRenderbuffer(r.FRAMEBUFFER,ne,r.RENDERBUFFER,ue)}t.bindFramebuffer(r.FRAMEBUFFER,null)}function q(A,S,Y){const ne=n.get(A);S!==void 0&&R(ne.__webglFramebuffer,A,A.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),Y!==void 0&&ce(A)}function de(A){const S=A.texture,Y=n.get(A),ne=n.get(S);A.addEventListener("dispose",P);const ue=A.textures,le=A.isWebGLCubeRenderTarget===!0,Pe=ue.length>1;if(Pe||(ne.__webglTexture===void 0&&(ne.__webglTexture=r.createTexture()),ne.__version=S.version,o.memory.textures++),le){Y.__webglFramebuffer=[];for(let ve=0;ve<6;ve++)if(S.mipmaps&&S.mipmaps.length>0){Y.__webglFramebuffer[ve]=[];for(let Ee=0;Ee<S.mipmaps.length;Ee++)Y.__webglFramebuffer[ve][Ee]=r.createFramebuffer()}else Y.__webglFramebuffer[ve]=r.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){Y.__webglFramebuffer=[];for(let ve=0;ve<S.mipmaps.length;ve++)Y.__webglFramebuffer[ve]=r.createFramebuffer()}else Y.__webglFramebuffer=r.createFramebuffer();if(Pe)for(let ve=0,Ee=ue.length;ve<Ee;ve++){const He=n.get(ue[ve]);He.__webglTexture===void 0&&(He.__webglTexture=r.createTexture(),o.memory.textures++)}if(A.samples>0&&ae(A)===!1){Y.__webglMultisampledFramebuffer=r.createFramebuffer(),Y.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let ve=0;ve<ue.length;ve++){const Ee=ue[ve];Y.__webglColorRenderbuffer[ve]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,Y.__webglColorRenderbuffer[ve]);const He=s.convert(Ee.format,Ee.colorSpace),me=s.convert(Ee.type),Ae=v(Ee.internalFormat,He,me,Ee.colorSpace,A.isXRRenderTarget===!0),De=$(A);r.renderbufferStorageMultisample(r.RENDERBUFFER,De,Ae,A.width,A.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ve,r.RENDERBUFFER,Y.__webglColorRenderbuffer[ve])}r.bindRenderbuffer(r.RENDERBUFFER,null),A.depthBuffer&&(Y.__webglDepthRenderbuffer=r.createRenderbuffer(),T(Y.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(le){t.bindTexture(r.TEXTURE_CUBE_MAP,ne.__webglTexture),Ue(r.TEXTURE_CUBE_MAP,S);for(let ve=0;ve<6;ve++)if(S.mipmaps&&S.mipmaps.length>0)for(let Ee=0;Ee<S.mipmaps.length;Ee++)R(Y.__webglFramebuffer[ve][Ee],A,S,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ve,Ee);else R(Y.__webglFramebuffer[ve],A,S,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ve,0);m(S)&&d(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Pe){for(let ve=0,Ee=ue.length;ve<Ee;ve++){const He=ue[ve],me=n.get(He);t.bindTexture(r.TEXTURE_2D,me.__webglTexture),Ue(r.TEXTURE_2D,He),R(Y.__webglFramebuffer,A,He,r.COLOR_ATTACHMENT0+ve,r.TEXTURE_2D,0),m(He)&&d(r.TEXTURE_2D)}t.unbindTexture()}else{let ve=r.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ve=A.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ve,ne.__webglTexture),Ue(ve,S),S.mipmaps&&S.mipmaps.length>0)for(let Ee=0;Ee<S.mipmaps.length;Ee++)R(Y.__webglFramebuffer[Ee],A,S,r.COLOR_ATTACHMENT0,ve,Ee);else R(Y.__webglFramebuffer,A,S,r.COLOR_ATTACHMENT0,ve,0);m(S)&&d(ve),t.unbindTexture()}A.depthBuffer&&ce(A)}function X(A){const S=A.textures;for(let Y=0,ne=S.length;Y<ne;Y++){const ue=S[Y];if(m(ue)){const le=w(A),Pe=n.get(ue).__webglTexture;t.bindTexture(le,Pe),d(le),t.unbindTexture()}}}const J=[],y=[];function te(A){if(A.samples>0){if(ae(A)===!1){const S=A.textures,Y=A.width,ne=A.height;let ue=r.COLOR_BUFFER_BIT;const le=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Pe=n.get(A),ve=S.length>1;if(ve)for(let Ee=0;Ee<S.length;Ee++)t.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Pe.__webglFramebuffer);for(let Ee=0;Ee<S.length;Ee++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(ue|=r.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(ue|=r.STENCIL_BUFFER_BIT)),ve){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Pe.__webglColorRenderbuffer[Ee]);const He=n.get(S[Ee]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,He,0)}r.blitFramebuffer(0,0,Y,ne,0,0,Y,ne,ue,r.NEAREST),c===!0&&(J.length=0,y.length=0,J.push(r.COLOR_ATTACHMENT0+Ee),A.depthBuffer&&A.resolveDepthBuffer===!1&&(J.push(le),y.push(le),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,y)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,J))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ve)for(let Ee=0;Ee<S.length;Ee++){t.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.RENDERBUFFER,Pe.__webglColorRenderbuffer[Ee]);const He=n.get(S[Ee]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,Pe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.TEXTURE_2D,He,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Pe.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const S=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[S])}}}function $(A){return Math.min(i.maxSamples,A.samples)}function ae(A){const S=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function O(A){const S=o.render.frame;h.get(A)!==S&&(h.set(A,S),A.update())}function L(A,S){const Y=A.colorSpace,ne=A.format,ue=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||Y!==Dt&&Y!==Un&&(Ze.getTransfer(Y)===rt?(ne!==qt||ue!==wn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",Y)),S}function se(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=W,this.resetTextureUnits=z,this.setTexture2D=oe,this.setTexture2DArray=Z,this.setTexture3D=ie,this.setTextureCube=k,this.rebindTextures=q,this.setupRenderTarget=de,this.updateRenderTargetMipmap=X,this.updateMultisampleRenderTarget=te,this.setupDepthRenderbuffer=ce,this.setupFrameBufferTexture=R,this.useMultisampledRTT=ae}function a0(r,e){function t(n,i=Un){let s;const o=Ze.getTransfer(i);if(n===wn)return r.UNSIGNED_BYTE;if(n===_a)return r.UNSIGNED_SHORT_4_4_4_4;if(n===va)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Ll)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Cl)return r.BYTE;if(n===Pl)return r.SHORT;if(n===_s)return r.UNSIGNED_SHORT;if(n===ga)return r.INT;if(n===ai)return r.UNSIGNED_INT;if(n===tn)return r.FLOAT;if(n===Ki)return r.HALF_FLOAT;if(n===Il)return r.ALPHA;if(n===Dl)return r.RGB;if(n===qt)return r.RGBA;if(n===Nl)return r.LUMINANCE;if(n===Ul)return r.LUMINANCE_ALPHA;if(n===Ci)return r.DEPTH_COMPONENT;if(n===Hi)return r.DEPTH_STENCIL;if(n===xa)return r.RED;if(n===ya)return r.RED_INTEGER;if(n===Ol)return r.RG;if(n===Ma)return r.RG_INTEGER;if(n===Sa)return r.RGBA_INTEGER;if(n===ur||n===fr||n===dr||n===pr)if(o===rt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ur)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===fr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===pr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ur)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===fr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===dr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===pr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Lo||n===Io||n===Do||n===No)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Lo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Io)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Do)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===No)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Uo||n===Oo||n===Fo)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Uo||n===Oo)return o===rt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Fo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Bo||n===ko||n===zo||n===Ho||n===Vo||n===Go||n===Wo||n===Xo||n===qo||n===Yo||n===Ko||n===jo||n===Zo||n===$o)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Bo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ko)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===zo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ho)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Vo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Go)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Wo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Xo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===qo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Yo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ko)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===jo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Zo)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===$o)return o===rt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===mr||n===Jo||n===Qo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===mr)return o===rt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Jo)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Qo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Fl||n===ea||n===ta||n===na)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===mr)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ea)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ta)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===na)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===zi?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const c0={type:"move"};class mo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new on,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new on,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new B,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new B),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new on,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new B,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new B),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,s=null,o=null;const a=this._targetRay,c=this._grip,l=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(l&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,n),d=this._getHandJoint(l,_);m!==null&&(d.matrix.fromArray(m.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=m.radius),d.visible=m!==null}const h=l.joints["index-finger-tip"],u=l.joints["thumb-tip"],f=h.position.distanceTo(u.position),p=.02,g=.005;l.inputState.pinching&&f>p+g?(l.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!l.inputState.pinching&&f<=p-g&&(l.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(c.matrix.fromArray(s.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,s.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(s.linearVelocity)):c.hasLinearVelocity=!1,s.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(s.angularVelocity)):c.hasAngularVelocity=!1));a!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(c0)))}return a!==null&&(a.visible=i!==null),c!==null&&(c.visible=s!==null),l!==null&&(l.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new on;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const l0=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `};this.rgbShiftPass=new _r(n),this.rgbShiftPass.enabled=!1;const i=this.settings.darkModeEffects.distortion;this.distortionTime=0,this.lastDistortionUpdate=0,this.distortionUpdateInterval=1e3/i.updateFPS,this.distortionTriggerInterval=i.triggerInterval,this.lastDistortionTrigger=0,this.distortionDuration=i.duration,this.distortionActive=!1,this.currentDistortionOffset=0,this.smearPositionSeed=Math.random()*100,this.composer.addPass(this.rgbShiftPass);const s={uniforms:{tDiffuse:{value:null},distortionAmount:{value:0},distortionSeed:{value:0},smearPositionSeed:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `};this.distortionPass=new _r(s),this.distortionPass.enabled=!1,this.composer.addPass(this.distortionPass);const o={uniforms:{tDiffuse:{value:null},resolution:{value:new he(this.container.clientWidth,this.container.clientHeight)},brightness:{value:1.05},scanlineIntensity:{value:.15},vignetteIntensity:{value:.5},glowIntensity:{value:.3}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,transparent:!0,blending:Bn,depthWrite:!1})}_startRingFade(e){this.devRingFadeStartOpacity=this.devOrbitRing?.mat.uniforms.globalOpacity.value??0,this.devRingFadeStartTime=Date.now(),this.devRingFadeDir=e,this.devRingFadeLength=e>0?this.demoRingFadeInLength:this.demoRingFadeOutLength}_updateRingGeos(){if(!this.devOrbitRing)return;const e=this.demoSpinOverlayRadius;this.devOrbitRing.geo.setFromPoints(this.buildOrbitPoints(e)),this.devOrbitRing.geo.setAttribute("alpha",new gt(this.buildOrbitAlphas(e),1)),this.devOrbitRing.tickGeo.setFromPoints(this.buildTickPoints(e)),this.devOrbitRing.tickGeo.setAttribute("alpha",new gt(this.buildTickAlphas(e),1))}createDevOrbitRing(){const e=new on,t=this._ringShaderMaterial(),n=this.demoSpinOverlayRadius,i=new St().setFromPoints(this.buildOrbitPoints(n));i.setAttribute("alpha",new gt(this.buildOrbitAlphas(n),1));const s=new Ql(i,t);e.add(s);const o=new St().setFromPoints(this.buildTickPoints(n));o.setAttribute("alpha",new gt(this.buildTickAlphas(n),1));const a=new Ss(o,t);e.add(a),this.scene.add(e),this.devOrbitRing={group:e,ring:s,geo:i,mat:t,ticks:a,tickGeo:o}}setDemoOrbRadius(e){this.demoSpinOverlayRadius=e,this._updateRingGeos()}setTickLength(e){this.demoSpinOverlayTickHalf=e/2,this._updateRingGeos()}setTickDensity(e){this.demoSpinOverlayTickN=e,this._updateRingGeos()}setLineColor(e){this.demoSpinOverlayLineColor=e,this.devOrbitRing&&this.devOrbitRing.mat.uniforms.lineColor.value.set(e)}setGlowColor(e){this.demoSpinOverlayGlowColor=e,this.demoSpinOverlay&&(this.demoSpinOverlay.needleMat.color.set(e),this.demoSpinOverlay.light.color.set(e))}setNeedleSpeed(e){this.demoSpinOverlayNeedleSpeed=e}setRingFadeInOffset(e){this.demoRingFadeInOffset=e}setRingFadeInLength(e){this.demoRingFadeInLength=e}setRingFadeOutOffset(e){this.demoRingFadeOutOffset=e}setRingFadeOutLength(e){this.demoRingFadeOutLength=e}setNeedleFadeOutOffset(e){this.demoNeedleFadeOutOffset=e}setNeedleFadeOutLength(e){this.demoNeedleFadeOutLength=e}setNeedleFadeInLength(e){this.demoNeedleFadeInLength=e}setOrbitXRotation(e){this.demoSpinOverlayXRotation=e,this._updateRingGeos()}setOrbitYRotation(e){this.demoSpinOverlayYRotation=e*Math.PI/180,this._updateRingGeos()}createDemoOrb(e){const n=new La(.025,.025,.4,8),i=new rn({color:new Le(this.demoSpinOverlayGlowColor),blending:Bn,transparent:!0,depthWrite:!1,opacity:1}),s=new mt(n,i);this.scene.add(s);const o=new fh(new Le(this.demoSpinOverlayGlowColor),0,3);this.scene.add(o);const a=this.demoSpinOverlayXRotation*Math.PI/180,c=Math.atan2(Math.sin(a)*Math.cos(this.demoSpinOverlayYRotation),-Math.sin(this.demoSpinOverlayYRotation));this.demoSpinOverlay={needle:s,needleMat:i,needleGeo:n,light:o,NEEDLE_HALF:.2,angle:c,opacity:0,fadingOut:!1,fadeInStartTime:Date.now(),fadeStartTime:null,rLetter:e}}updateDemoOrb(){const e=this.demoSpinOverlay,t=e.rLetter;if(!t?.mesh)return;const n=new B;t.mesh.getWorldPosition(n);const i=this.demoSpinOverlayRadius,s=this.demoSpinOverlayXRotation*Math.PI/180,o=this.demoSpinOverlayYRotation;e.angle+=t.hoverVelocity*this.demoSpinOverlayNeedleSpeed;const a=i*Math.cos(e.angle),c=i*Math.sin(e.angle)*Math.cos(s),l=i*Math.sin(e.angle)*Math.sin(s),h=n.x+a*Math.cos(o)+l*Math.sin(o),u=n.y+c,f=n.z+(-a*Math.sin(o)+l*Math.cos(o))+.3;e.needle.position.set(h,u,f);const p=Math.cos(s)*Math.sin(o),g=-Math.sin(s),_=Math.cos(s)*Math.cos(o);if(e.needle.quaternion.setFromUnitVectors(new B(0,1,0),new B(p,g,_)),e.light.position.set(h,u,f),e.fadingOut){const m=Math.min((Date.now()-e.fadeStartTime)/this.demoNeedleFadeOutLength,1);if(e.opacity=1-m,m>=1){this.disposeDemoOrb();return}}else{const m=Math.min((Date.now()-e.fadeInStartTime)/Math.max(this.demoNeedleFadeInLength,1),1);e.opacity=m}e.needleMat.opacity=e.opacity,e.light.intensity=e.opacity*1.5}hideDemoOrb(){this.demoSpinOverlay&&(this.demoSpinOverlay.fadingOut=!0,this.demoSpinOverlay.fadeStartTime=Date.now())}disposeDemoOrb(){const e=this.demoSpinOverlay;e&&(this.scene.remove(e.needle),this.scene.remove(e.light),e.needleMat.dispose(),e.needleGeo.dispose(),this.demoSpinOverlay=null)}dispose(){this.resizeObserver&&this.resizeObserver.disconnect(),this.renderer&&this.renderer.dispose()}}async function dv(){const r=localStorage.getItem("bgColor")||"#ffffff",e=localStorage.getItem("isDarkMode")==="true";document.body.style.backgroundColor=r;const t=document.getElementById("loading-overlay");t&&(t.style.backgroundColor=r),e&&document.body.classList.add("dark-mode");const n=document.getElementById("three-container");n.innerHTML='<div style="display: flex; align-items: center; justify-content: center; height: 100%; font-family: Courier; font-size: 14pt;">Loading shapes...</div>';const i=new Mh;await i.loadCustomShapes();const s=i.fileLoader.config._scene||{};n.innerHTML="";const o=new fv(n,i,s);requestAnimationFrame(()=>{requestAnimationFrame(()=>{const c=document.getElementById("loading-overlay");c&&(c.classList.add("hidden"),setTimeout(()=>{c.remove(),o.runDemoSpin()},400)),document.body.classList.add("loaded")})});const a=s.bgColors||["#ffffff"];return{scene:o,bgColors:a}}const Sh=await dv(),Ut=Sh.scene,si=Sh.bgColors,Fa=document.getElementById("refresh"),Ui=document.getElementById("pause-motion"),ri=document.getElementById("dark-mode"),Er=document.getElementById("bg-color-btn"),Eh=document.getElementById("bg-color-label"),pv=localStorage.getItem("bgColor")||si[0],Th=localStorage.getItem("isPaused")==="true",bh=localStorage.getItem("isDarkMode")==="true";let oi=si.findIndex(r=>r.toLowerCase()===pv.toLowerCase());oi===-1&&(oi=0);Ui.setAttribute("aria-pressed",String(Th));ri.setAttribute("aria-pressed",String(bh));Ut.setBackgroundColor(si[oi]);Eh.textContent=si[oi].toUpperCase();Ut.setPaused(Th);Ut.setDarkMode(bh);Ba();Fa.addEventListener("click",()=>{Ut.regenerateLetters()});Ui.addEventListener("click",()=>{const r=Ui.getAttribute("aria-pressed")!=="true";Ui.setAttribute("aria-pressed",String(r)),localStorage.setItem("isPaused",r),Ut.setPaused(r),Ba()});ri.addEventListener("click",()=>{const r=ri.getAttribute("aria-pressed")!=="true";ri.setAttribute("aria-pressed",String(r)),localStorage.setItem("isDarkMode",r),Ut.setDarkMode(r),document.body.classList.toggle("dark-mode",r),Ba()});Er.addEventListener("click",r=>{oi=(oi+(r.shiftKey?-1:1)+si.length)%si.length;const e=si[oi];localStorage.setItem("bgColor",e),Ut.setBackgroundColor(e),document.body.style.backgroundColor=e,Eh.textContent=e.toUpperCase()});function Ba(){const r=Ui.getAttribute("aria-pressed")==="true",e=ri.getAttribute("aria-pressed")==="true";xo(ri,r),xo(Er,r||e),xo(Fa,r)}function xo(r,e){r.classList.toggle("is-na",e),r.disabled=e}window.addEventListener("keydown",r=>{if(r.metaKey||r.ctrlKey||r.altKey)return;const e=document.activeElement?.tagName;if(!(e==="INPUT"||e==="TEXTAREA"||e==="SELECT"||e==="BUTTON"))switch(r.key){case"s":Fa.click();break;case"d":ri.click();break;case"b":Er.click();break;case"B":Er.dispatchEvent(new MouseEvent("click",{shiftKey:!0}));break;case"p":Ui.click();break;case"c":case"C":Ut.spinLetter("C");break;case"o":case"O":Ut.spinLetter("O");break;case"r":case"R":Ut.spinLetter("R");break;case"i":case"I":Ut.spinLetter("I");break;case"n":case"N":Ut.spinLetter("N");break;case"g":case"G":Ut.cycleGroup();break}});function Ah(){requestAnimationFrame(Ah),Ut.update()}Ah();
