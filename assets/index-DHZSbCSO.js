...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function nl(){return new nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:za(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function il(){return new nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:za(),fragmentShader:`
	...
	`}function wg(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const c=a.mapping,l=c===Do||c===No,h=c===Bi||c===ki;if(l||h){let u=e.get(a);const f=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==f)return t===null&&(t=new el(s)),u=l?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const p=a.image;return l&&p&&p.height>0||h&&p&&i(p)?(t===null&&(t=new el(s)),u=l?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",r),u.texture):null}}}return a}function i(a){let c=0;const l=6;for(let h=0;h<l;h++)a[h]!==void 0&&c++;return c===l}function r(a){const c=a.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function Rg(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&Ri("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function Cg(s,e,t,n){const i={},r=new WeakMap;function o(u){const f=u.target;f.index!==null&&e.remove(f.index);for(const g in f.attributes)e.remove(f.attributes[g]);f.removeEventListener("dispose",o),delete i[f.id];const p=r.get(f);p&&(e.remove(p),r.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,t.memory.geometries--}function a(u,f){return i[f.id]===!0||(f.addEventListener("dispose",o),i[f.id]=!0,t.memory.geometries++),f}function c(u){const f=u.attributes;for(const p in f)e.update(f[p],s.ARRAY_BUFFER)}function l(u){const f=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const w=p.array;_=p.version;for(let v=0,x=w.length;v<x;v+=3){const I=w[v+0],C=w[v+1],P=w[v+2];f.push(I,C,C,P,P,I)}}else if(g!==void 0){const w=g.array;_=g.version;for(let v=0,x=w.length/3-1;v<x;v+=3){const I=v+0,C=v+1,P=v+2;f.push(I,C,C,P,P,I)}}else return;const m=new(Wl(f)?jl:Kl)(f,1);m.version=_;const d=r.get(u);d&&e.remove(d),r.set(u,m)}function h(u){const f=r.get(u);if(f){const p=u.index;p!==null&&f.version<p.version&&l(u)}else l(u);return r.get(u)}return{get:a,update:c,getWireframeAttribute:h}}function Pg(s,e,t){let n;function i(f){n=f}let r,o;function a(f){r=f.type,o=f.bytesPerElement}function c(f,p){s.drawElements(n,p,r,f*o),t.update(p,n,1)}function l(f,p,g){g!==0&&(s.drawElementsInstanced(n,p,r,f*o,g),t.update(p,n,g))}function h(f,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];t.update(m,n,1)}function u(f,p,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)l(f[d]/o,p[d],_[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,f,0,_,0,g);let d=0;for(let w=0;w<g;w++)d+=p[w]*_[w];t.update(d,n,1)}}this.setMode=i,this.setIndex=a,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Lg(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function Ig(s,e,t){const n=new WeakMap,i=new Qe;function r(o,a,c){const l=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(a);if(f===void 0||f.count!==u){let E=function(){P.dispose(),n.delete(a),a.removeEventListener("dispose",E)};f!==void 0&&f.texture.dispose();const p=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],d=a.morphAttributes.normal||[],w=a.morphAttributes.color||[];let v=0;p===!0&&(v=1),g===!0&&(v=2),_===!0&&(v=3);let x=a.attributes.position.count*v,I=1;x>e.maxTextureSize&&(I=Math.ceil(x/e.maxTextureSize),x=e.maxTextureSize);const C=new Float32Array(x*I*4*u),P=new ql(C,x,I,u);P.type=tn,P.needsUpdate=!0;const U=v*4;for(let M=0;M<u;M++){const F=m[M],z=d[M],W=w[M],K=x*I*4*M;for(let oe=0;oe<F.count;oe++){const Z=oe*U;p===!0&&(i.fromBufferAttribute(F,oe),C[K+Z+0]=i.x,C[K+Z+1]=i.y,C[K+Z+2]=i.z,C[K+Z+3]=0),g===!0&&(i.fromBufferAttribute(z,oe),C[K+Z+4]=i.x,C[K+Z+5]=i.y,C[K+Z+6]=i.z,C[K+Z+7]=0),_===!0&&(i.fromBufferAttribute(W,oe),C[K+Z+8]=i.x,C[K+Z+9]=i.y,C[K+Z+10]=i.z,C[K+Z+11]=W.itemSize===4?i.w:1)}}f={count:u,texture:P,size:new he(x,I)},n.set(a,f),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)c.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let p=0;for(let _=0;_<l.length;_++)p+=l[_];const g=a.morphTargetsRelative?1:1-p;c.getUniforms().setValue(s,"morphTargetBaseInfluence",g),c.getUniforms().setValue(s,"morphTargetInfluences",l)}c.getUniforms().setValue(s,"morphTargetsTexture",f.texture,t),c.getUniforms().setValue(s,"morphTargetsTextureSize",f.size)}return{update:r}}function Dg(s,e,t,n){let i=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(i.get(u)!==l&&(e.update(u),i.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",a)===!1&&c.addEventListener("dispose",a),i.get(c)!==l&&(t.update(c.instanceMatrix,s.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,s.ARRAY_BUFFER),i.set(c,l))),c.isSkinnedMesh){const f=c.skeleton;i.get(f)!==l&&(f.update(),i.set(f,l))}return u}function o(){i=new WeakMap}function a(c){const l=c.target;l.removeEventListener("dispose",a),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:o}}const _h=new Mt,sl=new sh(1,1),vh=new ql,xh=new $u,yh=new Ql,rl=[],ol=[],al=new Float32Array(16),cl=new Float32Array(9),ll=new Float32Array(4);function es(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=rl[i];if(r===void 0&&(r=new Float32Array(i),rl[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function _t(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function vt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function Lr(s,e){let t=ol[e];t===void 0&&(t=new Int32Array(e),ol[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function Ng(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function Ug(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;s.uniform2fv(this.addr,e),vt(t,e)}}function Og(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(_t(t,e))return;s.uniform3fv(this.addr,e),vt(t,e)}}function Fg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;s.uniform4fv(this.addr,e),vt(t,e)}}function Bg(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;ll.set(n),s.uniformMatrix2fv(this.addr,!1,ll),vt(t,n)}}function kg(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;cl.set(n),s.uniformMatrix3fv(this.addr,!1,cl),vt(t,n)}}function zg(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(_t(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),vt(t,e)}else{if(_t(t,n))return;al.set(n),s.uniformMatrix4fv(this.addr,!1,al),vt(t,n)}}function Hg(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function Vg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;s.uniform2iv(this.addr,e),vt(t,e)}}function Gg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;s.uniform3iv(this.addr,e),vt(t,e)}}function Wg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;s.uniform4iv(this.addr,e),vt(t,e)}}function Xg(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function qg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;s.uniform2uiv(this.addr,e),vt(t,e)}}function Yg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;s.uniform3uiv(this.addr,e),vt(t,e)}}function Kg(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;s.uniform4uiv(this.addr,e),vt(t,e)}}function jg(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(sl.compareFunction=Gl,r=sl):r=_h,t.setTexture2D(e||r,i)}function Zg(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||xh,i)}function $g(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||yh,i)}function Jg(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||vh,i)}function Qg(s){switch(s){case 5126:return Ng;case 35664:return Ug;case 35665:return Og;case 35666:return Fg;case 35674:return Bg;case 35675:return kg;case 35676:return zg;case 5124:case 35670:return Hg;case 35667:case 35671:return Vg;case 35668:case 35672:return Gg;case 35669:case 35673:return Wg;case 5125:return Xg;case 36294:return qg;case 36295:return Yg;case 36296:return Kg;case 35678:case 36198:case 36298:case 36306:case 35682:return jg;case 35679:case 36299:case 36307:return Zg;case 35680:case 36300:case 36308:case 36293:return $g;case 36289:case 36303:case 36311:case 36292:return Jg}}function e_(s,e){s.uniform1fv(this.addr,e)}function t_(s,e){const t=es(e,this.size,2);s.uniform2fv(this.addr,t)}function n_(s,e){const t=es(e,this.size,3);s.uniform3fv(this.addr,t)}function i_(s,e){const t=es(e,this.size,4);s.uniform4fv(this.addr,t)}function s_(s,e){const t=es(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function r_(s,e){const t=es(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function o_(s,e){const t=es(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function a_(s,e){s.uniform1iv(this.addr,e)}function c_(s,e){s.uniform2iv(this.addr,e)}function l_(s,e){s.uniform3iv(this.addr,e)}function h_(s,e){s.uniform4iv(this.addr,e)}function u_(s,e){s.uniform1uiv(this.addr,e)}function f_(s,e){s.uniform2uiv(this.addr,e)}function d_(s,e){s.uniform3uiv(this.addr,e)}function p_(s,e){s.uniform4uiv(this.addr,e)}function m_(s,e,t){const n=this.cache,i=e.length,r=Lr(t,i);_t(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||_h,r[o])}function g_(s,e,t){const n=this.cache,i=e.length,r=Lr(t,i);_t(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||xh,r[o])}function __(s,e,t){const n=this.cache,i=e.length,r=Lr(t,i);_t(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||yh,r[o])}function v_(s,e,t){const n=this.cache,i=e.length,r=Lr(t,i);_t(n,r)||(s.uniform1iv(this.addr,r),vt(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||vh,r[o])}function x_(s){switch(s){case 5126:return e_;case 35664:return t_;case 35665:return n_;case 35666:return i_;case 35674:return s_;case 35675:return r_;case 35676:return o_;case 5124:case 35670:return a_;case 35667:case 35671:return c_;case 35668:case 35672:return l_;case 35669:case 35673:return h_;case 5125:return u_;case 36294:return f_;case 36295:return d_;case 36296:return p_;case 35678:case 36198:case 36298:case 36306:case 35682:return m_;case 35679:case 36299:case 36307:return g_;case 35680:case 36300:case 36308:case 36293:return __;case 36289:case 36303:case 36311:case 36292:return v_}}class y_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Qg(t.type)}}class M_{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=x_(t.type)}}class S_{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const vo=/(\w+)(\])?(\[|\.)?/g;function hl(s,e){s.seq.push(e),s.map[e.id]=e}function E_(s,e,t){const n=s.name,i=n.length;for(vo.lastIndex=0;;){const r=vo.exec(n),o=vo.lastIndex;let a=r[1];const c=r[2]==="]",l=r[3];if(c&&(a=a|0),l===void 0||l==="["&&o+2===i){hl(t,l===void 0?new y_(a,s,e):new M_(a,s,e));break}else{let u=t.map[a];u===void 0&&(u=new S_(a),hl(t,u)),t=u}}}class xr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);E_(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],c=n[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function ul(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const T_=37297;let b_=0;function A_(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const fl=new Fe;function w_(s){Ze._getMatrix(fl,Ze.workingColorSpace,s);const e=`mat3( ${fl.elements.map(t=>t.toFixed(4))} )`;switch(Ze.getTransfer(s)){case Sr:return[e,"LinearTransferOETF"];case rt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function dl(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`
...
`)}function C_(s,e){let t;switch(e){case ru:t="Linear";break;case ou:t="Reinhard";break;case au:t="Cineon";break;case cu:t="ACESFilmic";break;case hu:t="AgX";break;case uu:t="Neutral";break;case lu:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const fr=new B;function P_(){Ze.getLuminanceCoefficients(fr);const s=fr.x.toFixed(4),e=fr.y.toFixed(4),t=fr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function D_(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function fs(s){return s!==""}function pl(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ml(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const N_=/^[ \t]*#include +<([\w\d./]+)>/gm;function ga(s){return s.replace(N_,O_)}const U_=new Map;function O_(s,e){let t=We[e];if(t===void 0){const n=U_.get(e);if(n!==void 0)t=We[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return ga(t)}const F_=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function gl(s){return s.replace(F_,B_)}function B_(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function _l(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function k_(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Rl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Bh?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Mn&&(e="SHADOWMAP_TYPE_VSM"),e}function z_(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Bi:case ki:e="ENVMAP_TYPE_CUBE";break;case wr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function H_(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case ki:e="ENVMAP_MODE_REFRACTION";break}return e}function V_(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Cl:e="ENVMAP_BLENDING_MULTIPLY";break;case iu:e="ENVMAP_BLENDING_MIX";break;case su:e="ENVMAP_BLENDING_ADD";break}return e}function G_(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function W_(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=k_(t),l=z_(t),h=H_(t),u=V_(t),f=G_(t),p=L_(t),g=I_(r),_=i.createProgram();let m,d,w=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+d);const v=w+m+o,x=w+d+a,I=ul(i,i.VERTEX_SHADER,v),C=ul(i,i.FRAGMENT_SHADER,x);i.attachShader(_,I),i.attachShader(_,C),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function P(F){if(s.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),W=i.getShaderInfoLog(I).trim(),K=i.getShaderInfoLog(C).trim();let oe=!0,Z=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(oe=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,I,C);else{const ie=dl(i,I,"vertex"),k=dl(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class Ir{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const cv=new Pr(-1,1,1,-1,0,1);class lv extends St{constructor(){super(),this.setAttribute("position",new ft([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new ft([0,2,0,0,2,0],2))}}const hv=new lv;class uv{constructor(e){this._mesh=new mt(hv,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,cv)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class yr extends Ir{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof nn?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=$l.clone(e.uniforms),this.material=new nn({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new uv(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class wl extends Ir{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const i=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let o,a;this.inverse?(o=0,a=1):(o=1,a=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(i.REPLACE,i.REPLACE,i.REPLACE),r.buffers.stencil.setFunc(i.ALWAYS,o,4294967295),r.buffers.stencil.setClear(a),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(i.EQUAL,1,4294967295),r.buffers.stencil.setOp(i.KEEP,i.KEEP,i.KEEP),r.buffers.stencil.setLocked(!0)}}class fv extends Ir{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class dv{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new he);this._width=n.width,this._height=n.height,t=new Vn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:ji}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new yr(av),this.copyPass.material.blending=bn,this.clock=new Td}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let i=0,r=this.passes.length;i<r;i++){const o=this.passes[i];if(o.enabled!==!1){if(o.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(i),o.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),o.needsSwap){if(n){const a=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(a.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),c.setFunc(a.EQUAL,1,4294967295)}this.swapBuffers()}wl!==void 0&&(o instanceof wl?n=!0:o instanceof fv&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new he);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,i=this._height*this._pixelRatio;this.renderTarget1.setSize(n,i),this.renderTarget2.setSize(n,i);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,i)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class pv extends Ir{constructor(e,t,n=null,i=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=i,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new Le}render(e,t,n){const i=e.autoClear;e.autoClear=!1;let r,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=i}}class mv{constructor(e,t=null,n={}){this.container=e,this.shapeFactory=t,this.letterManager=null,this.settings={spacing:n.spacing||3.5,lineHeight:n.lineHeight||3,mobileSpacing:n.mobileSpacing||2.5,mobileLineHeight:n.mobileLineHeight||2.5,friction:n.friction||.98,hoverToSpin:n.hoverToSpin||!1,returnToRest:n.returnToRest!==!1,returnToRestSpeed:n.returnToRestSpeed||.02,cameraZ:n.cameraZ||10,floating:n.floating||{enabled:!0,amplitude:{x:.1,y:.15,z:.05},rotation:{x:.05,y:.08,z:.03},speed:1,speedVariation:.3},demoSpin:n.demoSpin||{delay:4e3,scratchVelocity:.08,scratchDuration:300,scratchGap:400,spinVelocity:.9},demoSpinOverlay:n.demoSpinOverlay||{},darkModeEffects:n.darkModeEffects||{rgbShift:{enabled:!0,maxShiftPixels:3,animationSpeed:.016,blurIntensity:.2},distortion:{enabled:!0,triggerInterval:4e3,duration:400,updateFPS:12,smearWidth:.3,smearHeight:.3,segments:4,intensityMultiplier:4}}},this.init()}init(){this.scene=new pf;const e=this.container.clientWidth<768;this.camera=new Lt(e?75:50,this.container.clientWidth/this.container.clientHeight,.1,1e3),this.camera.position.z=e?this.settings.cameraZ:this.computeDesktopCameraZ(),this.renderer=new x0({antialias:!0,alpha:!0}),this.renderer.setClearColor(0,0),this.renderer.setSize(this.container.clientWidth,this.container.clientHeight),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.container.appendChild(this.renderer.domElement),this.composer=new dv(this.renderer),this.renderPass=new pv(this.scene,this.camera),this.composer.addPass(this.renderPass);const t=this.settings.darkModeEffects.rgbShift,n={uniforms:{tDiffuse:{value:null},shiftPixels:{value:t.maxShiftPixels},resolution:{value:new he(this.container.clientWidth,this.container.clientHeight)},blurSamples:{value:5}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,transparent:!0,blending:zn,depthWrite:!1})}_startRingFade(e){this.devRingFadeStartOpacity=this.devOrbitRing?.mat.uniforms.globalOpacity.value??0,this.devRingFadeStartTime=Date.now(),this.devRingFadeDir=e,this.devRingFadeLength=e>0?this.demoRingFadeInLength:this.demoRingFadeOutLength}_updateRingGeos(){if(!this.devOrbitRing)return;const e=this.demoSpinOverlayRadius;this.devOrbitRing.geo.setFromPoints(this.buildOrbitPoints(e)),this.devOrbitRing.geo.setAttribute("alpha",new gt(this.buildOrbitAlphas(e),1)),this.devOrbitRing.tickGeo.setFromPoints(this.buildTickPoints(e)),this.devOrbitRing.tickGeo.setAttribute("alpha",new gt(this.buildTickAlphas(e),1))}createDevOrbitRing(){const e=new an,t=this._ringShaderMaterial(),n=this.demoSpinOverlayRadius,i=new St().setFromPoints(this.buildOrbitPoints(n));i.setAttribute("alpha",new gt(this.buildOrbitAlphas(n),1));const r=new nh(i,t);e.add(r);const o=new St().setFromPoints(this.buildTickPoints(n));o.setAttribute("alpha",new gt(this.buildTickAlphas(n),1));const a=new Es(o,t);e.add(a),this.scene.add(e),this.devOrbitRing={group:e,ring:r,geo:i,mat:t,ticks:a,tickGeo:o}}setDemoOrbRadius(e){this.demoSpinOverlayRadius=e,this._updateRingGeos()}setTickLength(e){this.demoSpinOverlayTickHalf=e/2,this._updateRingGeos()}setTickDensity(e){this.demoSpinOverlayTickN=e,this._updateRingGeos()}setLineColor(e){this.demoSpinOverlayLineColor=e,this.devOrbitRing&&this.devOrbitRing.mat.uniforms.lineColor.value.set(e)}setGlowColor(e){this.demoSpinOverlayGlowColor=e,this.demoSpinOverlay&&(this.demoSpinOverlay.needleMat.color.set(e),this.demoSpinOverlay.light.color.set(e))}setNeedleSpeed(e){this.demoSpinOverlayNeedleSpeed=e}setRingFadeInOffset(e){this.demoRingFadeInOffset=e}setRingFadeInLength(e){this.demoRingFadeInLength=e}setRingFadeOutOffset(e){this.demoRingFadeOutOffset=e}setRingFadeOutLength(e){this.demoRingFadeOutLength=e}setNeedleFadeOutOffset(e){this.demoNeedleFadeOutOffset=e}setNeedleFadeOutLength(e){this.demoNeedleFadeOutLength=e}setNeedleFadeInLength(e){this.demoNeedleFadeInLength=e}setOrbitXRotation(e){this.demoSpinOverlayXRotation=e,this._updateRingGeos()}setOrbitYRotation(e){this.demoSpinOverlayYRotation=e*Math.PI/180,this._updateRingGeos()}createDemoOrb(e){const n=new Ua(.025,.025,.4,8),i=new on({color:new Le(this.demoSpinOverlayGlowColor),blending:zn,transparent:!0,depthWrite:!1,opacity:1}),r=new mt(n,i);this.scene.add(r);const o=new mh(new Le(this.demoSpinOverlayGlowColor),0,3);this.scene.add(o);const a=this.demoSpinOverlayXRotation*Math.PI/180,c=Math.atan2(Math.sin(a)*Math.cos(this.demoSpinOverlayYRotation),-Math.sin(this.demoSpinOverlayYRotation));this.demoSpinOverlay={needle:r,needleMat:i,needleGeo:n,light:o,NEEDLE_HALF:.2,angle:c,opacity:0,fadingOut:!1,fadeInStartTime:Date.now(),fadeStartTime:null,rLetter:e}}updateDemoOrb(){const e=this.demoSpinOverlay,t=e.rLetter;if(!t?.mesh)return;const n=new B;t.mesh.getWorldPosition(n);const i=this.demoSpinOverlayRadius,r=this.demoSpinOverlayXRotation*Math.PI/180,o=this.demoSpinOverlayYRotation;e.angle+=t.hoverVelocity*this.demoSpinOverlayNeedleSpeed;const a=i*Math.cos(e.angle),c=i*Math.sin(e.angle)*Math.cos(r),l=i*Math.sin(e.angle)*Math.sin(r),h=n.x+a*Math.cos(o)+l*Math.sin(o),u=n.y+c,f=n.z+(-a*Math.sin(o)+l*Math.cos(o))+.3;e.needle.position.set(h,u,f);const p=Math.cos(r)*Math.sin(o),g=-Math.sin(r),_=Math.cos(r)*Math.cos(o);if(e.needle.quaternion.setFromUnitVectors(new B(0,1,0),new B(p,g,_)),e.light.position.set(h,u,f),e.fadingOut){const m=Math.min((Date.now()-e.fadeStartTime)/this.demoNeedleFadeOutLength,1);if(e.opacity=1-m,m>=1){this.disposeDemoOrb();return}}else{const m=Math.min((Date.now()-e.fadeInStartTime)/Math.max(this.demoNeedleFadeInLength,1),1);e.opacity=m}e.needleMat.opacity=e.opacity,e.light.intensity=e.opacity*1.5}hideDemoOrb(){this.demoSpinOverlay&&(this.demoSpinOverlay.fadingOut=!0,this.demoSpinOverlay.fadeStartTime=Date.now())}disposeDemoOrb(){const e=this.demoSpinOverlay;e&&(this.scene.remove(e.needle),this.scene.remove(e.light),e.needleMat.dispose(),e.needleGeo.dispose(),this.demoSpinOverlay=null)}dispose(){this.resizeObserver&&this.resizeObserver.disconnect(),this.renderer&&this.renderer.dispose()}}async function gv(){const s=localStorage.getItem("bgColor")||"#ffffff",e=localStorage.getItem("isDarkMode")==="true";document.documentElement.style.backgroundColor=s;const t=document.getElementById("loading-overlay");t&&(t.style.backgroundColor=s),e&&document.body.classList.add("dark-mode");const n=document.getElementById("three-container");n.innerHTML='<div style="display: flex; align-items: center; justify-content: center; height: 100%; font-family: Courier; font-size: 14pt;">Loading shapes...</div>';const i=new Th;await i.loadCustomShapes();const r=i.fileLoader.config._scene||{};n.innerHTML="";const o=new mv(n,i,r);requestAnimationFrame(()=>{requestAnimationFrame(()=>{const c=document.getElementById("loading-overlay");if(c){const l=r.demoLoadDelay?5e3:0;setTimeout(()=>{c.classList.add("hidden"),setTimeout(()=>{c.remove(),o.runDemoSpin()},400)},l)}document.body.classList.add("loaded")})});const a=r.bgColors||["#ffffff"];return{scene:o,bgColors:a}}const bh=await gv(),Ut=bh.scene,ai=bh.bgColors,Ar=document.getElementById("refresh"),si=document.getElementById("pause-motion"),kn=document.getElementById("dark-mode"),ws=document.getElementById("bg-color-btn"),Ah=document.getElementById("bg-color-label"),_v=localStorage.getItem("bgColor")||ai[0],wh=localStorage.getItem("isPaused")==="true",Rh=localStorage.getItem("isDarkMode")==="true";let ci=ai.findIndex(s=>s.toLowerCase()===_v.toLowerCase());ci===-1&&(ci=0);si.setAttribute("aria-pressed",String(wh));kn.setAttribute("aria-pressed",String(Rh));Ut.setBackgroundColor(ai[ci]);Ah.textContent=ai[ci].toUpperCase();Ut.setPaused(wh);Ut.setDarkMode(Rh);Ha();Ar.addEventListener("click",()=>{Ls(Ar),Ut.regenerateLetters(),Dr("Letters shuffled")});si.addEventListener("click",()=>{Ls(si);const s=si.getAttribute("aria-pressed")!=="true";si.setAttribute("aria-pressed",String(s)),localStorage.setItem("isPaused",s),Ut.setPaused(s),Dr(s?"Animation off":"Animation on"),Ha()});kn.addEventListener("click",()=>{Ls(kn);const s=kn.getAttribute("aria-pressed")!=="true";kn.setAttribute("aria-pressed",String(s)),localStorage.setItem("isDarkMode",s),Ut.setDarkMode(s),document.body.classList.toggle("dark-mode",s),Dr(s?"Dark mode on":"Dark mode off"),Ha()});ws.addEventListener("click",s=>{Ls(ws),ci=(ci+(s.shiftKey?-1:1)+ai.length)%ai.length;const e=ai[ci];localStorage.setItem("bgColor",e),Ut.setBackgroundColor(e),Ah.textContent=e.toUpperCase(),Dr("Background colour changed")});function Ha(){const s=si.getAttribute("aria-pressed")==="true",e=kn.getAttribute("aria-pressed")==="true";Eo(kn,s),Eo(ws,s||e),Eo(Ar,s)}function Eo(s,e){s.classList.toggle("is-na",e),s.disabled=e}function Dr(s){const e=document.getElementById("announcer");e.textContent="",requestAnimationFrame(()=>{e.textContent=s})}function Ls(s){s&&(s.classList.remove("is-activated"),s.offsetWidth,s.classList.add("is-activated"),s.addEventListener("animationend",()=>s.classList.remove("is-activated"),{once:!0}))}function sn(s){Ls(document.querySelector(`.keyboard-key[data-key="${s}"]`))}window.addEventListener("keydown",s=>{if(s.metaKey||s.ctrlKey||s.altKey)return;const e=document.activeElement?.tagName;if(!(e==="INPUT"||e==="TEXTAREA"||e==="SELECT"||e==="BUTTON"))switch(s.key){case"s":sn("s"),Ar.click();break;case"d":sn("d"),kn.click();break;case"b":sn("b"),ws.click();break;case"B":sn("b"),ws.dispatchEvent(new MouseEvent("click",{shiftKey:!0}));break;case"p":sn("p"),si.click();break;case"c":case"C":sn("c"),Ut.spinLetter("C");break;case"o":case"O":sn("o"),Ut.spinLetter("O");break;case"r":case"R":sn("r"),Ut.spinLetter("R");break;case"i":case"I":sn("i"),Ut.spinLetter("I");break;case"n":case"N":sn("n"),Ut.spinLetter("N");break;case"g":case"G":Ut.cycleGroup();break}});function Ch(){requestAnimationFrame(Ch),Ut.update()}Ch();
